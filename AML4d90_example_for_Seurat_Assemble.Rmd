...
seu$dataset[grepl("^TN_34", colnames(seu))]<-"34_enrich"
seu$dataset[grepl("^TN_BM", colnames(seu))]<-"BM"
table(seu$dataset)
```
...
```{r}
saveRDS(seu, file.path(CDS_DIR, "220926_seuratObj_TN1_celltype_genotype.RDS"))
seu <- readRDS(file = file.path(CDS_DIR, "220926_seuratObj_TN1_celltype_genotype.RDS"))
